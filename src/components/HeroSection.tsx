            ...
            <div className="flex-1 text-center lg:text-left space-y-6 order-2 lg:order-2">
              <div className={`space-y-4 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}>
                ...
                <div className="flex gap-4 justify-center lg:justify-start">
                  <a href="https://www.facebook.com/nishant.maurya.585112/" target="_blank" rel="noopener noreferrer" 
                  ...
                  <a href="https://wa.me/918840301998" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
                    <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
