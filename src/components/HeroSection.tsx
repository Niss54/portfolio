      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="max-w-3xl space-y-6">
          <div className={`space-y-4 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}>
            <div className="text-primary text-lg font-medium">Hello, I'm</div>
            ...
            <div className="flex gap-4">
              <a href="https://bit.ly/4pubDys" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
              ...
              <a href="https://bit.ly/3LMyPJM" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
              ...
              <a href="https://www.linkedin.com/in/niss-visuals" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
              ...
              <a href="http://bit.ly/4oUt1MH" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
              ...
              <a href="https://github.com/Niss54" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
                className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
              ...
              <a href="https://www.youtube.com/@Niss.visuals" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
                className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
              ...
              <a href="https://t.me/Nissvisuals" target="_blank" rel="noopener noreferrer" aria-label="Telegram"
                className="w-10 h-10 flex items-center justify-center glass rounded-lg border border-primary/20 hover:border-primary/50 hover:bg-primary/10 transition-all">
...
const GlassButton = ({ label, onClick, icon }: { label: string; onClick: () => void; icon?: React.ReactNode }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="no-site-button group relative px-8 py-4 bg-foreground/5 backdrop-blur-2xl rounded-full font-semibold text-foreground hover:bg-foreground/10 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-3 overflow-visible"
    >
