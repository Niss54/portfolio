              ...
              <div className="flex flex-wrap items-center justify-center gap-3">
                ...
                <a
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(
                    `Check out my ${selectedCert.name} certificate!`
                  )}&url=${encodeURIComponent(window.location.href)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-10 h-10 bg-secondary hover:bg-secondary/80 text-secondary-foreground border border-border rounded-xl transition-all duration-300 hover:scale-105"
                ...
                <a
                  href={`https://wa.me/?text=${encodeURIComponent(
                    `Check out my ${selectedCert.name} certificate! ${window.location.href}`
                  )}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-10 h-10 bg-secondary hover:bg-secondary/80 text-secondary-foreground border border-border rounded-xl transition-all duration-300 hover:scale-105"
